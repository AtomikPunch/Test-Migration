...
Then("I create a new account from header {string}", (client_reference) => {cy.i_create_a_new_account_from_header(client_reference);})
...
Given("Generate email random {string}", (client_reference) => {cy.generate_email_random(client_reference);})
